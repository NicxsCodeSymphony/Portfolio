...
export interface ApiAboutSectionAboutSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    resumeLink: Schema.Attribute.Text;
    skills: Schema.Attribute.Component<'skills.skills-component', true>;
...
export interface ApiContactSectionContactSection
  ...
  attributes: {
    ...
    socialLinks: Schema.Attribute.Component<
      'social-link.social-link-component',
      true
    >;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiHeroSectionHeroSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaButton: Schema.Attribute.Component<'cta.cta', true>;
    description: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
