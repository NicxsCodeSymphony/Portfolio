...
"[project]/pages/api/heroPage.ts [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const handlePost = async (req, res)=>{
    ...
    try {
        const ref = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseAdmin$2e$ts__$5b$api$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].ref('heroPage').push();
        const uid = ref.key;
        if (!uid) {
            return res.status(500).json({
...
const handlePut = async (req, res)=>{
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseAdmin$2e$ts__$5b$api$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].ref(`heroPage/${uid}`).update({
            award,
            url,
            updated_at: now()
        });
...
const handleDelete = async (req, res)=>{
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseAdmin$2e$ts__$5b$api$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].ref(`heroPage/${uid}`).remove();
        return res.status(200).json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cb5135c5._.js.map