...
"[project]/pages/api/personalInfo.ts [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const handleGet = async (_req, res)=>{
    try {
        const snapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseAdmin$2e$ts__$5b$api$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].ref('personalInfo').once('value');
        const data = snapshot.val();
        const personalInfo = data ? Object.entries(data).map(([uid, award])=>({
                uid,
                ...award
            })) : [];
...
const handlePost = async (req, res)=>{
    ...
    try {
        const ref = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseAdmin$2e$ts__$5b$api$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].ref('personalInfo').push();
        const uid = ref.key;
        if (!uid) {
            return res.status(500).json({
...
const handlePut = async (req, res)=>{
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseAdmin$2e$ts__$5b$api$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].ref(`personalInfo/${uid}`).update({
            award,
            url,
            updated_at: now()
        });
...
const handleDelete = async (req, res)=>{
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseAdmin$2e$ts__$5b$api$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].ref(`personalInfo/${uid}`).remove();
        return res.status(200).json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__61b9a390._.js.map