...
export default function Navbar() {
  ...
  function NavLink({ href, children }: NavLinkProps) {
    return (
      <Link href={href} legacyBehavior>
        <a className="text-gray-300 hover:text-white transition-colors relative group cursor-pointer">
          {children}
    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        <Link href="/" legacyBehavior>
          <a className="text-2xl font-bold bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent cursor-pointer">
            John Nico M. Edisan
          </a>
        </Link>
